...
public class Jogador {
	...
	public void perguntarNumeroDaSorte() {
		while(numeroDaSorte < 1 || numeroDaSorte > 10) {
			numero = JOptionPane.showInputDialog(null, String.format("Olá %s, qual seu número da sorte? (Entre 1 e 10)",nome),"Número da sorte",JOptionPane.QUESTION_MESSAGE);
	...
	public void setNumeroDaSorte(int numSorte) {
		this.numeroDaSorte = numSorte;
	}
