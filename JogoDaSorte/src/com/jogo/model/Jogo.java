...
public class Jogo {
	...
	public void sortearNumero() {
		...
		JOptionPane.showMessageDialog(null, String.format("Número sorteado: %d", numeroSorteado),"Resultado", JOptionPane.INFORMATION_MESSAGE);
	}
	...
	private void definirAposta() {
		String numero = JOptionPane.showInputDialog(null, "Qual é o valor da aposta?", "Aposta", JOptionPane.QUESTION_MESSAGE);
